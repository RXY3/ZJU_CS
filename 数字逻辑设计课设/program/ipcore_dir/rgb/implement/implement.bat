...
xst -ifn xst.scr
move rgb_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\rgb_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc rgb_exdes.ucf rgb_exdes

echo 'Running map'
map -timing rgb_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm rgb_exdes -w routed.ncd routed.v
cd ..
